...
const RoomsPage: FunctionComponent = () => {
  ...
  // New states for enhanced room form
    ...
    <body>
      ...
      <div class="section">
        ...
        <ul>
          ...
          <li>Bảo trì, sửa chữa các hư hỏng không do lỗi của Bên B</li>
        </ul>
        ...
        <ul>
          ...
          <li>Tuân thủ nội quy của phòng trọ</li>
          <li>Thông báo kịp thời khi có hư hỏng</li>
        </ul>
      </div>
              ...
              <DialogContent className="max-w-4xl w-[95vw] max-h-[95vh] overflow-y-auto mx-auto">
                <form onSubmit={handleAddRoom}>
                  <DialogHeader className="pb-4">
                    <DialogTitle className="text-xl font-semibold text-center">Thêm phòng mới</DialogTitle>
