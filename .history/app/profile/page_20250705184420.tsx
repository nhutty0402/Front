...
export default function ProfilePage() {
  const { managerProfile, updateManagerProfile } = useHostel()
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Thông tin cá nhân đã được cập nhật thành công và sẽ được sử dụng cho các hợp đồng mới",
      })
    } catch (error) {
      toast({
        title: "Lỗi",
        ...
        <div className="hidden lg:block bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Quản lý thông tin cá nhân và nhà trọ (sẽ được sử dụng cho hợp đồng)</p>
            </div>
        ...
        <div className="p-4 lg:p-6 space-y-6">
          ...
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Thông tin này sẽ được sử dụng làm thông tin bên cho thuê trong hợp đồng</CardDescription>
            </CardHeader>
          ...
          <Card className="border-0 shadow-sm">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Thông tin này sẽ được sử dụng trong hợp đồng thuê phòng</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div className="space-y-2">
